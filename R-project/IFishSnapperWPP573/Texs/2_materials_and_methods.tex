...
\begin{center}
\graphicspath{{/root/R-project/IFishSnapperWPP573/Images/}}
\includegraphics[scale=0.7]{DFD-PrimoIndoIkan.jpg}
...
\begin{center}
\graphicspath{{/root/R-project/IFishSnapperWPP573/Images/}}
\includegraphics[scale=0.8]{swss1.jpg}
...
\begin{center}
\graphicspath{{/root/R-project/IFishSnapperWPP573/Images/}}
\includegraphics[scale=0.35]{swss2.jpg}
...
\begin{tabular}{|l|l|l|}
\hline
\textbf{Data collection method}                                                               & \textbf{\begin{tabular}[c]{@{}l@{}}6 October 2014 -\\ 5 October 2015\end{tabular}} & \textbf{\begin{tabular}[c]{@{}l@{}}From October 2015\\ onwards\end{tabular}}                      \\ \hline
\begin{tabular}[c]{@{}l@{}}SMWS in Bali \\ (PT Primo Indo Ikan)\end{tabular}                  & Yes                                                                                         & \begin{tabular}[c]{@{}l@{}}Not reported here, but data \\ collection continues for\\ later analysis\end{tabular} \\ \hline
\begin{tabular}[c]{@{}l@{}}SMWS in Bali \\ (UD Damena)\end{tabular}                           & No                                                                                          & \begin{tabular}[c]{@{}l@{}}Not reported here, data \\ collection started in June\\ 2016\end{tabular}             \\ \hline
Traders in Kupang                                                                             & Yes                                                                                         & \begin{tabular}[c]{@{}l@{}}Not reported here; data \\ collection continued until \\ May\\ 2016\end{tabular}      \\ \hline
\begin{tabular}[c]{@{}l@{}}Traders in Tanjung Luar, \\ Lombok\end{tabular}                    & \begin{tabular}[c]{@{}l@{}}Only few data available, \\ not reported here\end{tabular}       & No                                                                                                               \\ \hline
\begin{tabular}[c]{@{}l@{}}CODRS operating from NTT \\ (Rote, Kupang, Tablolong)\end{tabular} & No                                                                                          & Yes, in this report                                                                                              \\ \hline
CODRS operating from Bali                                                                     & No                                                                                          & Yes, in this report                                                                                            \\ \hline
\begin{tabular}[c]{@{}l@{}}CODRS operating from \\ East Java (Probolinggo)\end{tabular}       & No                                                                                          & Yes, in this report                                                                                              \\ \hline
\end{tabular}

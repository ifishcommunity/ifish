...
<<globaloptions,echo=FALSE>>=
  opts_chunk$set(echo=FALSE, fig.path='/root/R-project/IFishSnapperWPP712_713/Plots/plot-', cache=FALSE)
@

\newgeometry{left=1cm,top=1cm,right=1cm,bottom=1cm}
\input{/root/R-project/IFishSnapperWPP712_713/Texs/coverpage.tex}
\restoregeometry

\input{/root/R-project/IFishSnapperWPP712_713/Texs/innercoverpage.tex}
\clearpage
...
\input{/root/R-project/IFishSnapperWPP712_713/Texs/1_introduction.tex}
...
print(t1, caption.placement = 'top', size='\\small', include.rownames=FALSE,
  add.to.row = list(
    pos = list(0),
    command = c(
...
\input{/root/R-project/IFishSnapperWPP712_713/Texs/2_materials_and_methods.tex}

\newpage

\chapter{Fishing grounds and traceability}
\input{/root/R-project/IFishSnapperWPP712_713/Texs/3_fishing_grounds.tex}
...
if(is.na(spx$slope_imm)) {spx$slope_imm <- 0;} #handling when value is NaN
...
if(is.na(spx$slope_lmat)) {spx$slope_lmat <- 0;} #handling when value is NaN
...
\input{/root/R-project/IFishSnapperWPP712_713/Texs/5_discussion_and_conclusions.tex}

\newpage

\chapter{References}
\input{/root/R-project/IFishSnapperWPP712_713/Texs/6_references.tex}

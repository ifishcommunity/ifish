<%-- 
    Document   : rptmdcu
    Created on : Dec 22, 2016, 10:09:19 AM
    Author     : gwawan
--%>
...
String wherePartner = "(" + DbPartner.colNames[DbPartner.COL_TYPE] + " = '" + IFishConfig.PARTNER_COMPANY + "'"
        + " or " + DbPartner.colNames[DbPartner.COL_TYPE] + " = '" + IFishConfig.PARTNER_FISH_TRADER + "')";
...
if(whereClause.length() > 0) {
    whereClause += " and " + DbDeepSlope.colNames[DbDeepSlope.COL_APPROACH] + " = " + IFishConfig.APPROACH_MDCU;
} else {
    whereClause = DbDeepSlope.colNames[DbDeepSlope.COL_APPROACH] + " = " + IFishConfig.APPROACH_MDCU;
}
...
<script language="javascript">
    ...
    function cmdDelete(oid, name) {
        ...
        document.frmrptmdcu.start.value="0";
        document.frmrptmdcu.landing_id.value=oid;
        document.frmrptmdcu.command.value="<%=JSPCommand.DELETE%>";
        document.frmrptmdcu.command_list.value="<%=JSPCommand.LIST%>";
        document.frmrptmdcu.action="rptmdcu.jsp";
        document.frmrptmdcu.submit();
        }
    }
    ...
    function cmdListFirst(){
        document.frmrptmdcu.command_list.value="<%=JSPCommand.FIRST%>";
        document.frmrptmdcu.action="rptmdcu.jsp";
        document.frmrptmdcu.submit();
    }

    function cmdListPrev(){
        document.frmrptmdcu.command_list.value="<%=JSPCommand.PREV%>";
        document.frmrptmdcu.action="rptmdcu.jsp";
        document.frmrptmdcu.submit();
    }

    function cmdListNext(){
        document.frmrptmdcu.command_list.value="<%=JSPCommand.NEXT%>";
        document.frmrptmdcu.action="rptmdcu.jsp";
        document.frmrptmdcu.submit();
    }

    function cmdListLast(){
        document.frmrptmdcu.command_list.value="<%=JSPCommand.LAST%>";
        document.frmrptmdcu.action="rptmdcu.jsp";
        document.frmrptmdcu.submit();
    }
</script>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><!-- #BeginEditable "content" -->
                        <form name="frmrptmdcu" method="post" action="">
                              ...
                              <td class="title">
                                <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                  <tr valign="bottom">
                                    ...
                                    <font class="tit1">&raquo; </font><span class="lvl2">MDCU</span></td>
                                            ...
                                            <td width="30%">
                                                <table border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmrptmdcu.start_date);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=rootSystem%>/calendar/calbtn.gif" height="19" border="0" alt="Start Date"></a>
                                                        </td>
                                                        <td>
                                                            &nbsp;&nbsp;until&nbsp;&nbsp;
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmrptmdcu.end_date);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=rootSystem%>/calendar/calbtn.gif" height="19" border="0" alt="End Date"></a></td>
                                                        <td>

<%-- 
    Document   : rptfindmespotmap
    Created on : Nov 19, 2014, 12:34:16 PM
    Author     : gwawan
--%>
...
<script language="javascript">
    ...
    function cmdList() {
        ...
        document.frmspottracemap.offset.value=offset;
        document.frmspottracemap.command.value="<%=JSPCommand.LIST%>";
        document.frmspottracemap.action="spottracemap.jsp";
        document.frmspottracemap.submit();
    }

    function cmdMap(ps) {
        var offset = new Date().getTimezoneOffset();
        document.frmspottracemap.offset.value=offset;
        document.frmspottracemap.command.value="<%=JSPCommand.NONE%>";
        document.frmspottracemap.program_site.value=ps;
        document.frmspottracemap.action="spottracemap.jsp";
        document.frmspottracemap.submit();
    }
    ...
    function checkboxAll(val) {
        ...
        for (int x = 0; x < listSelectedBoat.size(); x++) {
            ...
            out.println("document.frmspottracemap.boat_" + boat.getOID() + ".checked = val.checked;");
        }
        %>
    }
</script>
    ...
    <script>
        ...
        function initialize() {
          ...
          var mapOptions = {
              zoom: 5,
              maxZoom: 21,
              center: new google.maps.LatLng(-4, 118), //center of Indonesia
              panControl: false
          };
          ...
          <%
            ...
            if(list != null && list.size() > 0) {
                for(int i=0; i<list.size(); i++) {
                    ...
                    prevTrackerId = findMeSpot.getTrackerId();
                }
            }
          %>
        }
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><!-- #BeginEditable "content" -->
                        <form name="frmspottracemap" method="post" action="">
                              ...
                              <td class="title">
                                <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                  <tr valign="bottom">
                                    ...
                                    <font class="tit1">&raquo; </font><span class="lvl2">Map</span></td>
                                            ...
                                            <td width="30%">
                                                <table border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmspottracemap.start_date);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=rootSystem%>/calendar/calbtn.gif" height="19" border="0" alt="Start Date"></a>
                                                        </td>
                                                        <td>
                                                            &nbsp;&nbsp;until&nbsp;&nbsp;
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmspottracemap.end_date);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=rootSystem%>/calendar/calbtn.gif" height="19" border="0" alt="End Date"></a></td>
                                                        <td>

...
public class CONConnectionBroker implements Runnable {
    ...
    public CONConnectionBroker(String driver, String url, String user, String passwd, int curConn, int maxConn, String logFileName, double day) throws IOException {
        available = true;
